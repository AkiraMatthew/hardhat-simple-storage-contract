...
const add_content_helper_1 = require("./add-content.helper");
...
content line 2`;
            const result = (0, add_content_helper_1.addContent)(initial, newContent, config);
...
##replaceAbove
content line 3`;
            const result = (0, add_content_helper_1.addContent)(initial, [
                newContent,
...
##replaceBelow
content line 3`;
            expect(() => (0, add_content_helper_1.addContent)(initial, newContent, config)).toThrowError(`The replaceAbove marker '##replaceAbove' was found before the replaceBelow marker '##replaceBelow'. The replaceBelow marked must be before the replaceAbove.`);
        });
...
##replaceAbove
content line 3`;
            const result = (0, add_content_helper_1.addContent)(initial, `new content line one



new content line two`, config);
            expect(result).toBe(`content line 1
...
new content line two`, { ...config, removeDoubleBlankLines: true });
            expect(result).toBe(`content line 1

...
const configs_1 = require("../example/configs");
const write_markdown_constants_1 = require("../write-markdown.constants");
const markdown_helper_1 = require("./markdown.helper");
describe('markdown-helper', () => {
    it('should generate a simple usage guide with no additional sections and no alias column', () => {
        const info = {
            arguments: { ...configs_1.usageGuideInfo.arguments, copyFiles: Boolean },
        };
        const usageGuide = (0, markdown_helper_1.createUsageGuide)(info);
...
`);
    ...
    it('should generate a simple usage guide with no additional sections', () => {
        const usageGuide = (0, markdown_helper_1.createUsageGuide)(configs_1.usageGuideInfo);
        expect(usageGuide).toEqual(`
## Options
...
`);
    ...
    it('should generate a usage guide with sections', () => {
        const usageGuide = (0, markdown_helper_1.createUsageGuide)(write_markdown_constants_1.usageGuideInfo);
        expect(usageGuide).toEqual(`
## Markdown Generation
...
`);
    ...
    it('should generate a usage guide with option groups', () => {
        const usageGuide = (0, markdown_helper_1.createUsageGuide)(configs_1.typicalAppWithGroupsInfo);
        expect(usageGuide).toEqual(`
# A typical app
...
`);
    ...
    it('should generate a usage guide with table of examples', () => {
        const usageGuide = (0, markdown_helper_1.createUsageGuide)(configs_1.exampleSections);
        expect(usageGuide).toEqual(`
# A typical app
...
\\}
        ...
        const usageGuide = (0, markdown_helper_1.createUsageGuide)(typicalAppWithJSON);
        expect(usageGuide).toEqual(`
# A typical app
